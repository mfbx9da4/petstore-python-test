...
module OpenApiSDK
  ...
  class SDK
    ...
    sig { params(timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListPetsResponse) }
    def list_pets(timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response = Models::Operations::ListPetsResponse.new(
