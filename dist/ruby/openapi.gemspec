...
Gem::Specification.new do |s|
  ...
  s.summary     = ''
  s.homepage    = 'https://github.com/mfbx9da4/petstore-python-test.git'
  s.description = 'Ruby Client SDK Generated by Speakeasy'
  s.authors     = ['Speakeasy']
  s.metadata    = {
    'homepage_uri' => 'https://github.com/mfbx9da4/petstore-python-test.git',
    'documentation_uri' => 'https://github.com/mfbx9da4/petstore-python-test.git',
    'source_code_uri' => 'https://github.com/mfbx9da4/petstore-python-test.git'
  }
